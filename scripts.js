...
function buttonReco(messageInput){
    ...
    handleOutgoingMessage(messageInput, mealList);
};
...
const handleOutgoingMessage = (messageInput, mealList ) => {
...
sendAll.addEventListener("click", (e) => {
    e.preventDefault();
    messageInput = `Give me recommendations on my all day for a balanced day at ${totalCaloriesBegin} calories.`;
    buttonReco(messageInput);
});

sendBreakfast.addEventListener("click", (e) => {
    e.preventDefault();
    messageInput = `Give me recommendations on my breakfast for a balanced day at ${totalCaloriesBegin} calories.`;
    buttonReco(messageInput);
});

sendLunch.addEventListener("click", (e) => {
    e.preventDefault();
    messageInput = `Give me recommendations on my lunch for a balanced day at ${totalCaloriesBegin} calories.`;
    buttonReco(messageInput);
});

sendSnack.addEventListener("click", (e) => {
    e.preventDefault();
    messageInput = `Give me recommendations on my snack for a balanced day at ${totalCaloriesBegin} calories.`;
    buttonReco(messageInput);
});
